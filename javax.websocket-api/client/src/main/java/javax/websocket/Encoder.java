...
public interface Encoder {
     ...
     * 
     * @param <T>
     *            The type of the custom object that this Encoder can encoder to
     *            a ByteBuffer.
     */
     ...
     * 
     * @param <T>
     *            The type of the custom developer object that this Encoder can
     ...
     * 
     * @param <T>
     *            the type of the object this encoder can encode to a
     *            CharacterStream.
     * @since DRAFT 006 / EDR
     */
	 ...
	 *             if there was an error encoding the object due to its
	 *             state.
	 * @throws IOException
